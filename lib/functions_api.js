...
//user ------------------------------------------------------
//create or edit user
var senduser = async function(detail, callback)
{
    var path = address.host + address.user;
...
//get user detail
var getuser = async function(id, callback)
{
    var path = address.host + address.user + '/get/' + id;
...
{
    //archive
    senduser, getuser, checkmedia, getfavorites,
