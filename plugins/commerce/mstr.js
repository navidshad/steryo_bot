module.exports.commerce = 
{
    ...
    mess : {
      ...
      nexpayNote: '⭕️ ممکن است بعد از باز کردن لینک، از پرداخت منصرف شوید، و مجدد عملیات پرداخت را انجام دهید، در این شرایط نیاز است از طریق گزینه "🔄" لینک جدید پرداخت را دریافت نمایید.' + '\nاگر با خطای 43 مواجه شدید، پس از چند دقیقه مجدد لینک جدید بسازید و عملیات پرداخت رو تکرار کنید.',
    },
