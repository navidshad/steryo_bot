...
let showFactor = async function(userid,  option)
{
    ...
    mess += '\n\n' + '⭕️ ممکن است بعد از باز کردن لینک، از پرداخت منصرف شوید، و مجدد عملیات پرداخت را انجام دهید، در این شرایط نیاز است از طریق گزینه "🔄" لینک جدید پرداخت را دریافت نمایید.';
